            ...
            foreach ($rolePermissions as $permission): ?>
                <div class="col-md-4 mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="<?php echo $permission['action_id'] ?>"
                               id="perm_<?php echo $permission['action_id'] ?>"
                            <?= $permission['is_enabled'] ? 'checked' : '' ?>
                               data-action-id="<?php echo $permission['action_id'] ?>">
                        <label class="form-check-label" for="perm_<?php echo $permission['action_id'] ?>">
                            <?php echo htmlspecialchars($permission['action_label']) ?>
                        </label>
                    </div>
                </div>
            <?php
