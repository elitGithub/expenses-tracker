...
class SimpleJWS extends JWS
{
     ...
     * @param  string|null      $algo  The algorithms this JWS should be signed with. Use it if you want to restrict which algorithms you want to
     *     allow to be validated.
     *
     * @return bool
     */
    public function isValid($key, string $algo = null): bool
    {
