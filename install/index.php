...
if (file_exists(EXTR_ROOT_DIR . '/system/installation_includes.php')) {
    header('Location: /');
    exit(1);
}
            ...
            <form action="index.php" method="post" id="expenses-tracker-setup-form" name="expenses-tracker-setup-form" class="install-form d-none"
                ...
                <div data-form-section=1 id="step1" class="step">
                    ...
                    <div data-step="1" id="basic-info-form">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="sql_server" id="sql_server" class="form-control" placeholder="e.g. 127.0.0.1"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="sql_port" id="sql_port" class="form-control" placeholder="e.g. 3306"
                                       data-default-value="3306">
                                <small class="form-text text-muted">
                    ...
                    <div data-step="3" class="d-none" id="db-type-form">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-9 offset-sm-3">
                                ...
                                <label for="createMyOwnDb" class="form-check-label cursor-pointer">I want to create my own Database or I have an
                                    existing
                                    Database</label>
                            </div>
                        </div>
                ...
                <div data-form-section="3" id="step3" class="step d-none">
                    ...
                    <div data-step="1" id="Admin user form" class="row mb-2">
                        ...
                        <div class="row mb-2">
                            <label class="col-sm-3 col-form-label" for="admin_first_name">System Admin Name:</label>
                            <div class="col-sm-9">
                                <input type="text" name="admin_first_name" id="admin_first_name" class="form-control" required>
                                <small class="form-text text-muted">Please enter your real name.</small>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <label class="col-sm-3 col-form-label" for="admin_last_name">System Admin Last Name:</label>
                            <div class="col-sm-9">
                                <input type="text" name="admin_last_name" id="admin_last_name" class="form-control" required>
                                <small class="form-text text-muted">Please enter your real last name.</small>
                            </div>
                        </div>
                        <div class="row mb-2">
