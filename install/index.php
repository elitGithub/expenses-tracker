                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group" id="show_admin_password">
                                    <input name="admin_password" value="" type="password" autocomplete="off" minlength="8" id="admin_password"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group" id="show_retype_password">
                                    <input type="password" autocomplete="off" name="password_retype" id="password_retype" value="" minlength="8"
                                           class="form-control" required>
